...
public class QuizController {
  ...
  public QuestionResponseDto deleteSpecifiedQuestion(@PathVariable Long id, @PathVariable("questionID") Long questionId) {
      return quizService.deleteSpecifiedQuestion(id, questionId);
  }
}
